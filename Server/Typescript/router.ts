...
function route(pathName: any, handle: any, request: any, response: any) {  //SELF NOTE: Isn't any bad? Yes, but converting the node.js web framework to typescript was tricky and this is easiest conversion
